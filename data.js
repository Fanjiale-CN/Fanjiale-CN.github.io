window.GALOK_DATA = {
  ...
  pandemicRange: { start: 2020, end: 2023, label: "Pandemic window · 2020–2023" },
  ...
  indicators: [
    {
      ...
      note: "Annual real GDP growth, year over year.",
      status: "complete",
      values: {
    ...
    },
    {
      ...
      source: "National Bureau of Statistics (NBS)",
      sourceUrl: "https://www.stats.gov.cn/",
      note: "Consumer Price Index, year-over-year change.",
      status: "complete",
      values: {
    ...
    },
    {
      ...
      source: "National Bureau of Statistics (NBS)",
      sourceUrl: "https://www.stats.gov.cn/",
      note: "Producer Price Index, year-over-year change. The full 2000–2025 series is unverified — only confirmed years are included; the rest is left blank. Run /data/scrape_nbs.py against the NBS API to fill it in.",
      status: "partial",
      values: {
        2008: 6.9,
        2009: -5.4,
    ...
    },
    {
      ...
      source: "National Bureau of Statistics (NBS)",
      sourceUrl: "https://www.stats.gov.cn/",
      note: "Retail sales of consumer goods, year-over-year change. The full 2000–2025 series is unverified — only confirmed years are included. Run /data/scrape_nbs.py against the NBS API to fill it in.",
      status: "partial",
      values: {
        2020: -3.9,
        2021: 12.5,
