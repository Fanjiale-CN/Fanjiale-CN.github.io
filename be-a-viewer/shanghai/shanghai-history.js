(() => {
  ...
  async function mount() {
    ...
    stylesheet.href = "/be-a-viewer/shanghai/shanghai-history.css?v=20260827-sh20-layout-fix5";
    document.head.append(stylesheet);

    try {
      const response = await fetch("/be-a-viewer/shanghai/shanghai-history.json?v=20260827-sh20-layout-fix5", { cache: "force-cache" });
