...
const client = readFileSync(join(root, "assets", "observability-core.js"), "utf8");
...
if (!existsSync(join(root, "assets", "observability.js"))) throw new Error("Missing observability bootstrap.");
...
console.log("Observability validation passed: bootstrap, core analytics, event privacy and operator guide are present.");
